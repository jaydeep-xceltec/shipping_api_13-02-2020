...
const tradetimer = require('./tradetimer');

const cityForm = require('./city');

const diffForm = require('./diff');
...
router.post('/shareTradeRecordsServerSide',tradingPlatformRouteInfo.shareTradeRecordsServerSide);
router.post('/shareTrade',tradingPlatformRouteInfo.shareTrade);
router.post('/ownerShipRecordsServerSide',tradingPlatformRouteInfo.ownerShipRecordsServerSide);
router.post('/changeOwnerShip',tradingPlatformRouteInfo.changeOwnerShip);

//Route for user role
router.post('/createasubadmin',User.createasubadmin);
...
router.post('/createSubadmin',User.createsubadmin);
router.post('/removeUser',User.removeUser);
router.post('/retrieveUser',User.retrieveUser);
router.get('/userList',User.userList);
router.get('/userFatchListSoftDelete',User.userFatchListSoftDelete);
...
router.get('/companyadminListSoftDelete',User.companyadminListSoftDelete);
...
router.post('/companyadminretrieve',User.companyadminretrieve);
...
router.post('/tradingRecordsServerSideAccordingToVessel',tradingPlatformRouteInfo.tradingRecordsServerSideAccordingToVessel);
router.post('/emailSendCommon',tradingPlatformRouteInfo.emailSendCommon);
router.post('/tradingMessagesDataRecordsServerSide',tradingPlatformRouteInfo.tradingMessagesDataRecordsServerSide);
router.post('/tradeCancel',tradingPlatformRouteInfo.tradeCancel);

// router.post('/tradingMessagesDataRecordsServerSide',tradingPlatformRouteInfo.tradingMessagesDataRecordsServerSide);
// router.post('/tradingMessagesDataRecordsServerSide',tradingPlatformRouteInfo.tradingMessagesDataRecordsServerSide);
router.post('/invitationEmailSend',tradingPlatformRouteInfo.invitationEmailSend);
router.post('/invitationEmailSendCompanyAdmin',tradingPlatformRouteInfo.invitationEmailSendCompanyAdmin);
// router.post('/emailSendCommon',tradingPlatformRouteInfo.emailSendCommon);
router.post('/invitedUserRecordsServerSide',tradingPlatformRouteInfo.invitedUserRecordsServerSide);
// router.post('/changeOwnerShip',tradingPlatformRouteInfo.changeOwnerShip);
// router.post('/ownerShipRecordsServerSide',tradingPlatformRouteInfo.ownerShipRecordsServerSide);
// router.post('/shareTrade',tradingPlatformRouteInfo.shareTrade);
// router.post('/shareTradeRecordsServerSide',tradingPlatformRouteInfo.shareTradeRecordsServerSide);
router.post('/saveBid',tradingPlatformRouteInfo.saveBid);
router.post('/saveBidRecords',tradingPlatformRouteInfo.saveBidRecords);
...
router.get('/faqlistactive',faq.faqlistactive);
...
router.get('/tclistactive',tc.tclistactive);
...
// user  Setting Routes
router.get('/userSettinglist',userSetting.userSettinglist);
router.post('/userSettingcreate',userSetting.userSettingcreate);
router.post('/userSettingupdate',userSetting.userSettingupdate);
router.post('/userSettingdelete',userSetting.userSettingdelete);
router.post('/userSettingStatusUpdate',userSetting.userSettingStatusUpdate);


// user  Setting Routes
router.get('/tradetimerlist',tradetimer.tradetimerlist);
router.post('/tradetimercreate',tradetimer.tradetimercreate);
router.post('/tradetimerupdate',tradetimer.tradetimerupdate);
router.post('/tradetimerdelete',tradetimer.tradetimerdelete);
router.post('/tradetimerStatusUpdate',tradetimer.tradetimerStatusUpdate);
module.exports = router;

// New CODE START

router.post('/drawMessageInsert',drawForm.drawMessageInsert);
router.post('/drawNotificationInsert',drawForm.drawNotificationInsert);


//diff check
router.get('/DiffRecords',diffForm.DiffRecords);
router.post('/DiffCreate',diffForm.DiffCreate);
router.post('/DiffUpdate',diffForm.DiffUpdate);


router.get('/GetTerms',cu.GetTerms);